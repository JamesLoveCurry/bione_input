...
/**
 * The persistent class for the RPT_DETAIL_TMP_CATALOG database table.
 * 
 */
@Entity
@Table(name="RPT_DETAIL_TMP_CATALOG")
@NamedQuery(name="RptDetailTmpCatalog.findAll", query="SELECT r FROM RptDetailTmpCatalog r")
public class RptDetailTmpCatalog implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDetailTmpCatalog other = (RptDetailTmpCatalog) obj;
		if (catalogId == null) {
