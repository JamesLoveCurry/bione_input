...
public class BillCellItemVO implements Serializable, Cloneable {
	...
	private int valign = 2; //上下排序,1-靠顶;2-靠中;3-靠下

	private String span; //

	private boolean isForceStr = false; //是否强制字符串
	...
	//_fontStyle==0是正常，_fontStyle=1是粗体
	public void setFont(String _fonttype, int _fontsize) {
		setFont(_fonttype, _fontsize, 0); //
	}

	public void setFont(String _fonttype, int _fontsize, int _fontStyle) {
	...
	public boolean isForceStr() {
		return isForceStr;
	}

	public void setForceStr(boolean isForceStr) {
		this.isForceStr = isForceStr;
	}
