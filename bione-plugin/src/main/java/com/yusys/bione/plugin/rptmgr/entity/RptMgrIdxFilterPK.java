...
/**
 * The primary key class for the RPT_MGR_IDX_FILTER database table.
 * 
 */
@Embeddable
public class RptMgrIdxFilterPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RptMgrIdxFilterPK)) {
			return false;
		}
		RptMgrIdxFilterPK castOther = (RptMgrIdxFilterPK)other;
		return 
