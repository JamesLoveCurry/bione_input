...
/**
 * The primary key class for the RPT_DESIGN_COMCELL_INFO database table.
 * 
 */
@Embeddable
public class RptDesignComcellInfoPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignComcellInfoPK other = (RptDesignComcellInfoPK) obj;
		if (cellNo == null) {
