 ...
 */
@Embeddable
public class RptIdxPlanvalResultPK implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6544425116503645371L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptIdxPlanvalResultPK other = (RptIdxPlanvalResultPK) obj;
		if (currency == null) {
