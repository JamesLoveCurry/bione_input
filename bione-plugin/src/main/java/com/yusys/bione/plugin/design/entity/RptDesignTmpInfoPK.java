...
/**
 * The primary key class for the RPT_DESIGN_TMP_INFO database table.
 * 
 */
@Embeddable
public class RptDesignTmpInfoPK implements Serializable {
	...
	public void setRptTemplateId(String templateId){
		this.templateId = templateId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignTmpInfoPK other = (RptDesignTmpInfoPK) obj;
		if (templateId == null) {
