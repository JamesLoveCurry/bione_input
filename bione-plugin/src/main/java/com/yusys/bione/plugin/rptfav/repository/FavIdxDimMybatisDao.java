 ...
 */
@MyBatisRepository
public interface FavIdxDimMybatisDao {
	public List<RptFavIdxDim> list(Map<String, Object> map);
	public void save(RptFavIdxDim rel);
	public void update(RptFavIdxDim rel);
