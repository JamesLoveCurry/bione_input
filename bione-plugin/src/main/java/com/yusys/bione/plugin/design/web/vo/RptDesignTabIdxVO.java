...
public class RptDesignTabIdxVO implements Serializable{

	private static final long serialVersionUID = 2807002950378010523L;
	
	@ExcelColumn(index = "0", name = "单元格编号",colTitle = "指标列表单元格")
	private String cellNo;
	@ExcelColumn(index = "1", name = "单元格名称",colTitle = "指标列表单元格")
	private String cellNm;
	private String dataType;
	private String isUpt;
	private String isNull;
	private String dataLen;
	@ExcelColumn(index = "8", name = "数据精度",colTitle = "指标列表单元格")
	private String dataPrecision;
	@ExcelColumn(index = "6", name = "显示格式",colTitle = "指标列表单元格",value={"01","02","03","04","05","06","07"},text={"金额","比例","数值","文本","日期","百分点","小数"})
	private String displayFormat;
	@ExcelColumn(index = "7", name = "数据单位",colTitle = "指标列表单元格",value={"","00","01","02","03","04","05"},text={"模板单位","无单位","个","百","千","万","亿"})
	...
	@ExcelColumn(index = "2", name = "来源指标编号",colTitle = "指标列表单元格")
	private String indexNo;
	@ExcelColumn(index = "3", name = "来源指标名称",colTitle = "指标列表单元格")
	private String indexNm;
	private String indexVerId;
	@ExcelColumn(index = "4", name = "是否跑数汇总",colTitle = "指标列表单元格",value={"","Y","N"},text={"是","是","否"})
	private String isSum;
	@ExcelColumn(index = "13", name = "是否填报汇总",colTitle = "指标列表单元格",value={"","Y","N"},text={"是","是","否"})
	private String isFillSum;
	@ExcelColumn(index = "5", name = "是否落地",colTitle = "指标列表单元格",value={"","Y","N"},text={"是","是","否"})
	private String isSave;
	private String statType;
	private String measureNo;
	private String busiType;
	@ExcelColumn(index = "9", name = "计算规则",colTitle = "指标列表单元格",relDs={"com.yusys.bione.plugin.rptidx.entity.RptIdxCalcRule","ruleId","ruleNm"})
	private String ruleId;
	@ExcelColumn(index = "10", name = "时间度量",colTitle = "指标列表单元格",relDs={"com.yusys.bione.plugin.rptidx.entity.RptIdxTimeMeasure","timeMeasureId","measureNm"})
	private String timeMeasureId;
	@ExcelColumn(index = "11", name = "取值方式",colTitle = "指标列表单元格",relDs={"com.yusys.bione.plugin.rptidx.entity.RptIdxValType","modeId","modeNm"})
	private String modeId;
	@ExcelColumn(index = "12", name = "是否跨年",colTitle = "指标列表单元格",value={"","Y","N"},text={"","是","否"})
	private String isPassyear;
	//private String filtInfos;
	...
	/**
	 * @param timeMeasureId 设置 timeMeasureId。
	 */
