 ...
 */
@Embeddable
public class RptOrgSumRelPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RptOrgSumRelPK)) {
			return false;
		}
		RptOrgSumRelPK castOther = (RptOrgSumRelPK)other;
		return 
