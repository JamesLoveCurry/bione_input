...
@ExcelSheet(index = "5", name = "总分核对校验", firstRow = 1)
public class RuleSumImportVO implements Serializable, AnnotationValidable {
	...
	@BioneFieldValid(nullable=true, length = 1000)
	@ExcelColumn(index = "G", name = "分组字段")
	private String grpColName;
	@BioneFieldValid(nullable=true, length = 1000)
	@ExcelColumn(index = "H", name = "汇总表达式")
	private String expr;
	@ExcelColumn(index = "I", name = "最大相对误差", type = "number")
	...
	@ExcelColumn(index = "O", name = "规则业务类型", value = { "1", "2" }, text = { "全量SQL类型", "增量SQL类型" })
	...
	public String getGrpColName() {
		return grpColName;
	}
	public void setGrpColName(String grpColName) {
