...
/**
 * The primary key class for the rpt_design_source_tabidx database table.
 * 
 */
@Embeddable
public class RptDesignSourceTabidxPK implements Serializable {
    ...
    public RptDesignSourceTabidxPK() {
    }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignSourceTabidxPK other = (RptDesignSourceTabidxPK) obj;
		if (cellNo == null) {
