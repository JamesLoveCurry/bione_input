...
/**
 * The primary key class for the RPT_IDX_FORMULA_INFO database table.
 * 
 */
@Embeddable
public class RptIdxFormulaInfoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RptIdxFormulaInfoPK)) {
			return false;
		}
		RptIdxFormulaInfoPK castOther = (RptIdxFormulaInfoPK)other;
		return 
