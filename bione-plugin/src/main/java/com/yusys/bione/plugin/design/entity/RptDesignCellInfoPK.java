...
/**
 * The primary key class for the RPT_DESIGN_CELL_INFO database table.
 * 
 */
@Embeddable
public class RptDesignCellInfoPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignCellInfoPK other = (RptDesignCellInfoPK) obj;
		if (cellNo == null) {
