 ...
 * </pre>
 */
@ExcelSheet(index = "0", name = "1-报表基础信息", firstCol = 2, titleFlag = true, insertType = "01", extType = "02")
public class ExportReportInfoVO implements Serializable {
    ...
    @ExcelColumn(index = "4", name = "报表类型", colTitle = "基础信息", value = {"01", "02", "03", "04", "05", "06"}, text = {"明细报表", "单元格报表", "综合报表"})
    private String templateType; // 报表类型
    @ExcelColumn(index = "5", name = "生成周期", colTitle = "基础信息", value = {"01", "02", "03", "04", "10", "11", "12"}, text = {"日", "月", "季", "年", "周", "旬", "半年"})
    private String rptCycle; // 报表周期
    @ExcelColumn(index = "6", name = "报表单位", colTitle = "基础信息", value = {"01", "02", "03", "04", "05"}, text = {"元", "百", "千", "万", "亿"})
    private String templateUnit; // 报表单位
    @ExcelColumn(index = "7", name = "业务类型", colTitle = "基础信息", relDs={"com.yusys.bione.frame.variable.entity.BioneParamInfo","paramValue","paramName"," PARAM_TYPE_NO ='idxTaskType'"})
    private String busiType; // 业务类型（人行/1104）
    @ExcelColumn(index = "8", name = "联系人", colTitle = "基础信息")
    private String userName;//联系人名称
    @ExcelColumn(index = "9", name = "升级概况", colTitle = "基础信息", value = {"01", "02", "03", "04"}, text = {"新增", "修改", "停用", "无变化"})
    private String templateNm; // 升级概况
    @ExcelColumn(index = "10", name = "是否修改", colTitle = "基础信息", value = {"Y", "N"}, text = {"是", "否"}, combox = {"是", "否"})
    private String isUpt; // 是否修改
    @ExcelColumn(index = "11", name = "报表状态", colTitle = "基础信息", value = {"Y", "N"}, text = {"启用", "停用"}, combox = {"启用", "停用"})
    private String rptSts; // 报表状态
    @ExcelColumn(index = "12", name = "业务分库", colTitle = "基础信息")
    private String busiLibNm; //业务分库
    private String busiLibId; //业务分库
    @ExcelColumn(index = "13", name = "报表业务名称", colTitle = "基础信息")
    private String rptBusiNm;
    @ExcelColumn(index = "14", name = "业务定义", colTitle = "基础信息")
    private String rptDesc;
    @ExcelColumn(index = "15", name = "填报说明", colTitle = "基础信息")
    private String fillDesc;
    
    @ExcelColumn(index = "16", name = "制度表样版本", colTitle = "1104报送特殊配置")
    private String tmpVersionId;
    @ExcelColumn(index = "17", name = "制度表样编号", colTitle = "1104报送特殊配置")
    private String repId;
    @ExcelColumn(index = "18", name = "上报编码", colTitle = "1104报送特殊配置")
    private String reportCode; // 上报编码
    
    
    @ExcelColumn(index = "19", name = "是否定长",colTitle = "明细类报表特殊配置", value={"Y","N"},text={"是","否"})
	private String fixedLength;
	@ExcelColumn(index = "20", name = "是否分页",colTitle = "明细类报表特殊配置", value={"Y","N"},text={"是","否"})
	private String isPaging;
	@ExcelColumn(index = "21", name = "报表导入配置",colTitle = "明细类报表特殊配置")
	private String importConfig;
	@ExcelColumn(index = "22", name = "合计排序SQL",colTitle = "明细类报表特殊配置")
