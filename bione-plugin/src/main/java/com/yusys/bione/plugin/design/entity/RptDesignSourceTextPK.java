...
/**
 * The primary key class for the RPT_DESIGN_SOURCE_TEXT database table.
 * 
 */
@Embeddable
public class RptDesignSourceTextPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignSourceTextPK other = (RptDesignSourceTextPK) obj;
		if (cellNo == null) {
