...
import com.yusys.bione.plugin.eastreport.service.EastReportBs;
 ...
 */
@Component
public class EastReportResImpl implements IResObject {
    @Autowired
    private EastReportBs eastReportBs;
    ...
    public List<CommonTreeNode> doGetResInfo() {
        return this.eastReportBs.getAuthTree();
    }
