...
/**
 * The primary key class for the rpt_design_source_tabdim database table.
 * 
 */
@Embeddable
public class RptDesignSourceTabdimPK implements Serializable {
    ...
    public RptDesignSourceTabdimPK() {
    }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignSourceTabdimPK other = (RptDesignSourceTabdimPK) obj;
		if (cellNo == null) {
