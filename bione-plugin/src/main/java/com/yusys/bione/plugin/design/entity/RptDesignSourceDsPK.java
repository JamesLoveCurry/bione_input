...
/**
 * The primary key class for the RPT_DESIGN_SOURCE_DS database table.
 * 
 */
@Embeddable
public class RptDesignSourceDsPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RptDesignSourceDsPK other = (RptDesignSourceDsPK) obj;
		if (cellNo == null) {
