	...
	$(function() {
		...
		mainform.ligerForm({
			fields : [ 
			{
				...
				cssClass : "field",
				options:{
					url: "${ctx}/frs/pisamessage/getComboInfo.json?paramTypeNo=pisaSubmitFreq&d=" + new Date().getTime()
				},
				group : "报文生成信息",
				groupicon : groupicon,
				validate : {
		...
		if ($('#mainform').valid()) {
			...
			$.ajax({
				...
				success : function(result) {
					var downloadUrl = "${ctx}/frs/pisamessage/downLoadFile?id="+result.id+"&d="+ new Date().getTime();
