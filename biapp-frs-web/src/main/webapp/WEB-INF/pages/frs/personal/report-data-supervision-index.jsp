SHU<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<script type="text/javascript">
	...
	var selRowNo;
	var pageName = "report-data-supervision-index";
	...
	$(function() {
		...
		//督导管理 
		function manager(rowdata){
			var result =  "<a href='javascript:void(0)' class='link' onclick='onShowSupervision(\""+rowdata.depositName+"\",\""+rowdata.statisticsDt.substr('0','10')+"\",\""+rowdata.bankAcctNum+"\",\""+rowdata.finalSubmitDate+"\",\""+rowdata.errorType+"\")'>督导管理</a>";
			return result;
		}
	...
	function onShowSupervision(deposit_name,statistics_dt,bank_acct_num,final_submit_date,error_type){
		BIONE.commonOpenDialog('督导管理','supervision-manager',"800","400",'${ctx}/frs/personal/personalAccount/getSupervisionManager?deposit_name='+encodeURI(encodeURI(deposit_name))+'&statistics_dt='+statistics_dt+'&bank_acct_num='+bank_acct_num+'&final_submit_date='+final_submit_date+'&error_type='+error_type, null);
	}
