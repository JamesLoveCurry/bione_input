...
<script type="text/javascript">
	...
	var setting = {
			async:{
				enable:true,
				url:"${ctx}/frs/systemmanage/orgmanage/getOrgTree?t="+ new Date().getTime(),
				autoParam:["id"],
				dataType:"json",
				type:"get",
	...
	function initBtn() {
		btns.push({
			...
			onclick : function() {
					...
					main.selectTab.$.ligerui.get('orgNo').setValue(currentNode.id);
					main.selectTab.$.ligerui.get('orgNm').setValue(currentNode.text);
					main.selectTab.$("#mainform").valid();
					BIONE.closeDialog("chooseOrg");
			}
		});
