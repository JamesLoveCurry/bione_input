	...
	$(function() {
					...
					fields : [
							...
							},
							{
								...
								validate : {
									...
									maxlength : 100,
									remote : {
										url : "${ctx}/report/frame/param/templates/catalogNameCanUse?catalogId=${catalogId}&upId=${upId}&d="
											+ new Date(),
										type : 'post'
									},
									messages : {
								...
								display : "描述",
								name : "remark",//edit by fangjuan 2014-07-22
								labelWidth : 90,
								width : 400,
								newline : true,
								type : "textarea",
		...
		if (catalogId != "" && catalogId != null) {
			BIONE.loadForm(mainform,{
				type : "POST",
				url : "${ctx}/report/frame/param/templates/getCatalogInfo.json?catalogId="
...
<body>
	<div id="template.center">
		<form id="mainform" action="${ctx}/report/frame/param/templates/saveCatalog"
			method="POST"></form>
	</div>
</body>
</html>