...
<script type="text/javascript">
	...
	$(function() {
		url = "${ctx}/rpt/frame/dataset/listCatalogTree.json";
		beforeTree();
		initTree();
		selectButton();
	...
	function selected() {
		...
		parent.parent.datasetObj.catalogId = currentNode.id;
		parent.$("#mainform [name='catalogId']").val(currentNode.id);
		parent.$.ligerui.get('catalog_box').setText(currentNode.text);
		BIONE.closeDialog("datasetCatalogSlct");
	}
</script>
</head>
<body>
