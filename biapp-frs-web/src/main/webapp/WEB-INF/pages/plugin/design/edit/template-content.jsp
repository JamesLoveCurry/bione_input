...
<script id="template-content" type="text/x-jquery-tmpl" charset="utf-8">
		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
            		<tr>
                		...
                		<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="cellTypeNm" data-bind="value: cellTypeNm" type="text" id="cellTypeNm" ltype="text"  readonly=true /></td>
               			 <td align="left"></td>
            		</tr>
            		<tr data-bind="style:{ display : cellType()=='01'  || cellType() == '-1'? 'none' : ''}">
                		<td align="right" class="l-table-edit-td ">单元格编号:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="cellNo"  type="text" id="cellNo" ltype="text"  readonly=true /></td>
               			 <td align="left"></td>
            		</tr>
            		<tr data-bind="style:{ display : cellType()=='01' || cellType() == '-1'? 'none' : ''}">
                		<td align="right" class="l-table-edit-td">单元格名称:</td>
                			<td align="left" class="l-table-edit-td"><input onchange="cellNmChangeHandler()" class="own-formitem-style {"required":true}" name="cellNm" data-bind="value:cellNm,valueUpdate:'afterkeydown'" type="text" id="cellNm" ltype="text"/></td>
               			<td align="left">
					...
					<tr data-bind="style:{ display : cellType()=='03' || cellType()=='04' || cellType()=='05'? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">报表指标号:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="realIndexNo"  data-bind="value:realIndexNo,valueUpdate:'afterkeydown'"  type="text" id="realIndexNo" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr>
            		...
            		<tr data-bind="style:{ display : cellType()=='02' ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">数据模型:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="dsName"  data-bind="value:dsName,valueUpdate:'afterkeydown'"  type="text" id="dsName" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr>
            		<tr data-bind="style:{ display : cellType()=='02' ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">字段名称:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="columnName"  data-bind="value:columnName,valueUpdate:'afterkeydown'"  type="text" id="columnName" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr>
            		<tr data-bind="style:{ display : cellType()=='03' ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">来源指标:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="indexNm"  data-bind="value:indexNm,valueUpdate:'afterkeydown'"  type="text" id="indexNm" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr>
            		<!-- <tr data-bind="style:{ display : cellType()=='03' ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">是否减维:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="isSubDim"  data-bind="value:allDims() == factDims()? '否' : '是'"  type="text" id="isSubDim" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr> -->
            		<tr data-bind="style:{ display : cellType()=='03'  && (indexNo() != '' && indexNo() != null) ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">是否过滤:</td>
                			<td align="left" class="l-table-edit-td "><input class="own-formitem-style" name="isFiltDim"  data-bind="value:filtInfos() == null  || (typeof filtInfos() == 'string' && filtInfos().length <= 2) || (typeof filtInfos() == 'object' && filtInfos().length <= 0)?  '否' : '是'"  type="text" id="isFiltDim" ltype="text"  readonly=true/></td>
               			 <td align="left"></td>
            		</tr>
					...
					<tr data-bind="style:{ display : (templateType!='02' && cellType()=='04' && isAnalyseExt()=='Y') ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="analyseExtType" id="analyseExtType" ltype="select" data-bind="value:analyseExtType" >
            		...
            		<tr data-bind="style:{display : (cellType()=='01') || (cellType() == '-1' && _typeIdBatch())  ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="typeId" id="typeId" ltype="select" data-bind="value:typeId" >
					...
					<tr data-bind="style:{ display : ( cellType()=='01' && typeId()!='00')  ? '' : 'none'}">
                		<td align="right" class="l-table-edit-td">内容:</td>
                			<td align="left" class="l-table-edit-td">
								<textarea data-bind="value:content,valueUpdate:'afterkeydown'"class="l-textarea own-formitem-style" style="height:60px;resize:none;"></textarea>
							</td>
               			 <td align="left"></td>
            		</tr>
            		<!-- 计算规则 -->
					...
					<tr data-bind="style:{ display : (cellType() == '03' && templateType != '01') ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="isSum" id="isSum" ltype="select" data-bind="value:isSum" >
								<option value="Y">是</option>
								<option value="N">否</option>
								<option value="" style="display:none;"></option>
							</select>
					...
					<tr data-bind="style:{ display : (cellType() == '03' && templateType != '01') ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="isFillSum" id="isFillSum" ltype="select" data-bind="value:isFillSum" >
								<option value="Y">是</option>
								<option value="N">否</option>
								<option value="" style="display:none;"></option>
							</select>
					...
					<tr data-bind="style:{ display : (cellType() == '03' && templateType != '01') ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="isLock" id="isLock" ltype="select" data-bind="value:isLock">
								<option value="N">否</option>
								<option value="Y">是</option>
								<option value="" style="display:none;"></option>
							</select>
					...
					<tr data-bind="style:{ display : cellType()=='02' ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="isMerge" id="isMerge" ltype="select" data-bind="value:isMerge" >
								<option value="N">否</option>
								<option value="Y">是</option>
								<option value="" style="display:none;"></option>
							</select>
					...
					<tr data-bind="style:{ display : cellType()=='02' ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td">
                			<select class="own-formitem-style" name="isMergeCol" id="isMergeCol" ltype="select" data-bind="value:isMergeCol" >
								<option value="N">否</option>
								<option value="Y">是</option>
								<option value="" style="display:none;"></option>
							</select>
            		...
            		<tr data-bind="style:{ display : cellType()=='02' || cellType()=='03' || cellType()=='04' || cellType()=='05' ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td"> 
                			<textarea data-bind="value:caliberTechnology,valueUpdate:'afterkeydown'"class="l-textarea own-formitem-style" style="height:60px;resize:none;"></textarea>
                		</td>
                		<td align="left"></td>
            		</tr>
            		<tr data-bind="style:{ display : cellType()=='02' || cellType()=='03' || cellType()=='04' || cellType()=='05' ? '' : 'none'}">
                		...
                		<td align="left" class="l-table-edit-td"> 
                			<textarea data-bind="value:remark,valueUpdate:'afterkeydown'"class="l-textarea own-formitem-style" style="height:60px;resize:none;"></textarea>
                		</td>
                		<td align="left"></td>
            		</tr>
            	</table>
