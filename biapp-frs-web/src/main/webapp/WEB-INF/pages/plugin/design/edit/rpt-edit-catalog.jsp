...
<script type="text/javascript">
	...
	var setting = {
		...
		loadTree("${ctx}/report/frame/design/cfg/getRptCatalog?defSrc="+defSrc, leftTreeObj);
	}
	//加载树中数据
			...
			onclick : function() {
				...
				if (currentNode.id!="0") {
					if(changeType
						...
						if(window.parent.selectedTab.searchRankOrder)
							window.parent.selectedTab.searchRankOrder(currentNode.params.realId);
						BIONE.closeDialog("catalogTreeWin");
					}
				} else {
					BIONE.tip("请选择一个目录节点");
