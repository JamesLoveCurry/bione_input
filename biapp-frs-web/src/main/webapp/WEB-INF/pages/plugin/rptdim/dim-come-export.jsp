			...
			if(nodes == null || nodes == ""){
				...
				for(var i in nodes){
					if(nodes[i].params.type == "dimTypeInfo"){
						dimTypeNos += nodes[i].data.dimTypeNo + ",";
					}
				}
				dimTypeNos = dimTypeNos.substring(0,dimTypeNos.length-1);
				$.ajax({
					async:true,
					type:"POST",
					dataType:"json",
					url:"${ctx}/rpt/frame/dimCatalog/exportTmp",
					data:{"dimTypeNos":dimTypeNos},
