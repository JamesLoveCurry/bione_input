...
<head>
    ...
    <script type="text/javascript">
        ...
        function templateshow() {
            ...
            $("#right").height($centerDom.height() - 60);
            $("#left").height($centerDom.height() - 60);
            $("#treeContainer").height($centerDom.height()-58);
            if (grid) {
...
<body>
<div id="left" style="background-color: #FFFFFF;height: 100%">
