...
<script type="text/javascript">
	...
	function templateshow() {
    	...
    	$("#center").height($(window).height() - $("#bottom").height() - 8);
		$("#editor_div").height($("#center").height() - $("#baseinfo_div").height() - $("#attach_div").height() - 8);
		//computeIconsRows();
		if (CKEDITOR && CKEDITOR.config) {
			CKEDITOR.config.height = $("#editor_div").height() - 72 ;
		}
    }
...
<body>
	<div id="center">
		...
		<div id="editor_div" class="info_content" style="width: 98%; text-align:center; ">
			<ckeditor:editor basePath="${ctx}/static/AdminLTE-With-Iframe/plugins/ckeditor/" editor="editor1" value=""/>
		</div>
		<!-- "editor_div" end -->
		<!-- attach_div begin -->
