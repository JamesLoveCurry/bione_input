	...
	grid = $("#maingrid").ligerGrid({
		...
		format : 'yyyy-MM-dd hh:mm:ss'
			...
			render:function(a,b,c,d){
				return "<a href='javascript:void(0)' class='link' onclick='pauseJob(\""+a.taskId+"\",\""+a.taskSts+"\")'> 挂起 </a>  <a href='javascript:void(0)' class='link' onclick='resumeJob(\""+a.taskId+"\",\""+a.taskSts+"\")'> 继续 </a><a href='javascript:void(0)' class='link' onclick='startJob(\""+a.taskId+"\")'> 立即执行 </a>";
			}
		    } ],
	    checkbox : true,
	    rownumbers : true,
