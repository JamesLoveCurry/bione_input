...
function AfterInit() {
	JSPFree.createBillList("d1", "east/engineTask/batch_rule_east_cr_task_CODE");
	...
	str_sqlWhere = "tab_name is null and data_dt>='" + formatwdate + "' and data_dt <='" + formatnowdate + "'"; // 拼SQL条件
