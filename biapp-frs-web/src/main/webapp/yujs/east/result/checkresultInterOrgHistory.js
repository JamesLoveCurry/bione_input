...
function query(jso_OpenPars, _par){
	...
	var jso_par = null;
	if (_par != null && _par != "") {
		jso_par = {"SQLWhere": "org_nm='"+orgNm+"' and org_no = '"+orgNo+"' and tab_name='"+tabNm+"' and "+_par+" and "+condition};
	} else {
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.EastCheckResultAllHisBS","getInterOrgHistoryChart",jso_par); 
