...
function query(jso_OpenPars, _par){
	...
	if(_par != null && _par != ""){
		var jso_par = {"SQLWhere": "line_nm='"+lineNm+"' and tab_name='"+tabName+"' and "+_par};
	}
	else{
	    var date1 = dataDt;
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.EastCheckResultAllHisBS","getDepartHistoryChart",jso_par); 
