...
function AfterInit(){
	...
	var queryType = '2';
	var str_className = "Class:com.yusys.east.checkresult.summary.service.FailDetailTempletBuilder.getTemplet('"+tabName+"','"+tabNameEn+"','"+dataDt+"','"+addr +"','"+orgType +"','"+queryType+"')";
