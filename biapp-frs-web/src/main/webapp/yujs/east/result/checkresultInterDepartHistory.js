...
function query(jso_OpenPars, _par){
	var lineNm = jso_OpenPars.line_nm; 
	var tabNm = jso_OpenPars.tab_name;
	if(_par != null && _par != ""){
		var jso_par = {"SQLWhere": "line_nm='"+lineNm+"' and tab_name='"+tabNm+"' and "+_par};
	}
	else{
		var date=new Date();
		//年
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.EastCheckResultAllHisBS","getInterDepartHistoryChart",jso_par); 
