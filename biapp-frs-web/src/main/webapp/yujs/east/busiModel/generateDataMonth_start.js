...
function doRefreshData(){
	//加载数据!
	var jso_statu = JSPFree.doClassMethodCall("com.yusys.east.business.data.service.GenerateDataBS", "checkMonthGenerateDataStatus");
...
function onStart(){
	...
	var jso_rt = JSPFree.doClassMethodCall("com.yusys.east.business.data.service.GenerateDataBS", 
			"startMonthGenerateDataTask",jso_par);
