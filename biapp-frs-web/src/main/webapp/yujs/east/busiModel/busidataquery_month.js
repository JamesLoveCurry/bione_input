...
function AfterInit(){
	...
	document.getElementById("d1_B").innerHTML="<div style='width:100%;text-align:center'><span style='font-size:16px;color:blue'>请选择左边表查询总行数据!</span></div>";
	...
	JSPFree.bindBillTreeOnSelect(d1_A_BillTree,function(_node){
	  ...
	  if(isLeaf_1){  //如果选中了叶子结点
		  ...
		  var v_par = {"subfix":"_M","tab_name":str_tab_name,"tab_name_en":str_tab_name_en,"ds":str_ds};
