...
function AfterInit() {
	...
	JSPFree.createBillCard("d1", "/biapp-fsrs/freexml/fsrs/templetItem.xml",["保存/onConfirm/icon-p21","取消/onCancel/icon-undo"]); // 页签先左右分割
	...
	if(displayConfig !=null && displayConfig!=""){
		...
		var jso_data = JSPFree.doClassMethodCall("com.yusys.fsrs.business.service.FsrsCrColBS","getDisplayConfig",jso_par); 
