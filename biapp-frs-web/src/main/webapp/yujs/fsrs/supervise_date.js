function AfterInit(){
	JSPFree.createBillCard("d1","/biapp-fsrs/freexml/fsrs/supervise_date.xml",["确定/onConfirm","取消/onCancel"]);
...
function onConfirm(){
	...
	var jso_rt = JSPFree.doClassMethodCall("com.yusys.fsrs.report.service.FsrsRuleHandler","startAllTask",{data_dt:jso_cardData.data_dt});
