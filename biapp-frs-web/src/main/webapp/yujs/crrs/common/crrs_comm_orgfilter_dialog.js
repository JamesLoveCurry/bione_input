 ...
 */
function AfterInit() {
	JSPFree.createBillTreeByBtn("d1","/biapp-crrs/freexml/crrs/common/rpt_org_info_CODE1.xml",["确定/onConfirm/icon-ok","取消/onCancel/icon-clear"],{"isCheckbox":"Y","tree_isCheckboxCascade":"N"});
}
