...
function AfterInit(){
	...
	JSPFree.createBillList("d1","/biapp-crrs/freexml/crrs/rule/crrs_rule_result_FeedBack.xml",null,{list_btns:"[icon-p51]分发/onDispatch;$VIEW",querycontion:str_sqlCons,list_ischeckstyle:'Y',list_ismultisel:'Y'});  //确定性校验
