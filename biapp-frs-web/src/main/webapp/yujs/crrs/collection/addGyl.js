...
function AfterInit(){
	...
	JSPFree.createBillCard("d1_1","/biapp-crrs/freexml/crrs/group/crrs_group_group_client_CODE2.xml",["保存/onSave/icon-ok"],null);
	document.getElementById("d1_2").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护供应链基本信息</div>";
	document.getElementById("d1_3").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护供应链基本信息</div>";
	document.getElementById("d1_4").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护供应链基本信息</div>";

	//赋值
	JSPFree.setBillCardValues(d1_1_BillCard,{customer_type:'1',type:'2',credit_type:'2'});
}
	...
	if ("Y" == ischeck) {
		...
		if (backValue == "" || "undifind" == backValue) {
			...
			if(flag){
				...
				var gylData = JSPFree.getBillCardFormValue(d1_1_BillCard);
				JSPFree.openDialogAndCloseMe2("基础信息","/yujs/crrs/collection/editGyl.js",900,560,{gylData:gylData},true);
			}
