...
function AfterInit(){
	...
	d1_A_BillCard.OldData = jso_OpenPars2.executive; //修改之前的高管信息
	...
	defaultValue = {executives_id:executiveId,customer_type:"2",data_dt:str_data_dt,issued_no:str_issued_no};
