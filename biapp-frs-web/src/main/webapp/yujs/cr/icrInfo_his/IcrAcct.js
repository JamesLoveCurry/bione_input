...
function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/icrInfo_his/acct/IcrLoanInformation.xml");  //上面是基础段信息
	...
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/icrInfo_his/acct/IcrAcctBsInf.xml");  //个人基本信息 	

	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/icrInfo_his/acct/IcrRltRepymtInf.xml");  //个人借贷相关还款责任人
	JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/icrInfo_his/acct/IcrMotgaCltalCtrctInf.xml");  //抵质押物信息
	JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/icrInfo_his/acct/IcrAcctCred.xml");  //借贷授信额度信息	

	JSPFree.createBillList("d1_B_5","/biapp-cr/freexml/icrInfo_his/acct/IcrOrigCreditorInf.xml");  //初始债权说明
	JSPFree.createBillList("d1_B_6","/biapp-cr/freexml/icrInfo_his/acct/IcrAcctMthlyBlgInf.xml");  //月度表现信息	

	JSPFree.createBillList("d1_B_7","/biapp-cr/freexml/icrInfo_his/acct/IcrSpecPrd.xml");  //大额专项分期信息
	JSPFree.createBillList("d1_B_8","/biapp-cr/freexml/icrInfo_his/acct/IcrAcctDbtInf.xml");  //非月度表现信息	

	JSPFree.createBillList("d1_B_9","/biapp-cr/freexml/icrInfo_his/acct/IcrAcctSpecTrstDspn.xml");  //特殊交易说明
	JSPFree.createBillList("d1_B_10","/biapp-cr/freexml/icrInfo_his/acct/IcrCtrctBs.xml");  //授信协议基础信息	
    JSPFree.createBillList("d1_B_11","/biapp-cr/freexml/icrInfo_his/acct/IcrCtrctCertRel.xml");  //授信协议共同受信人信息
	JSPFree.createBillList("d1_B_12","/biapp-cr/freexml/icrInfo_his/acct/IcrCreditLim.xml");  //授信协议额度信息
	JSPFree.createBillList("d1_B_13","/biapp-cr/freexml/icrInfo_his/acct/IcrInSpcEvtDscInf.xml");  //特殊事件说明
