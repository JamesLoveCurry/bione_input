...
function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/entLoanInfo/EntLoanInformation.xml");
	JSPFree.createTabb("d1_B",["基本信息","授信额度","抵质押物","还款表现","相关还款责任人","初始债权说明","特定交易说明"]);
	
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/entLoanInfo/EntAcctBsInfo.xml");
	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/entLoanInfo/EntAcctCred.xml");
	JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/entLoanInfo/EntMotgaCltalCtrctInfo.xml");
	JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/entLoanInfo/EntActLbltyInfo.xml");
	JSPFree.createBillList("d1_B_5","/biapp-cr/freexml/entLoanInfo/EntRltRepymtInfo.xml");
	JSPFree.createBillList("d1_B_6","/biapp-cr/freexml/entLoanInfo/EntOrigCreditorInfo.xml");
	JSPFree.createBillList("d1_B_7","/biapp-cr/freexml/entLoanInfo/EntAcctSpecTrstDspnInfo.xml");
