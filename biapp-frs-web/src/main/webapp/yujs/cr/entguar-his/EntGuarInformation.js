...
function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/entguarxml-his/GuarBasicInfomation.xml");
	//创建相关联信息tab标签
	JSPFree.createTabb("d1_B",["基本信息","相关还款责任人","抵质押物信息","授信额度信息","在保责任信息"]);
	//基本信息
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/entguarxml-his/GuarAcctBsInf.xml");
	//相关还款责任人
	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/entguarxml-his/RltRepymtInf.xml");
	//抵质押物信息
	JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/entguarxml-his/GuarMotgaCltalCtrctInf.xml");
	//授信额度信息
	JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/entguarxml-his/GuarAcctCred.xml");
	//在保责任信息
	JSPFree.createBillList("d1_B_5","/biapp-cr/freexml/entguarxml-his/GuarRltRepymtInf.xml");
	//选择某条企业担保基础信息时触发的事件
