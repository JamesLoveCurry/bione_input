...
function AfterInit() {
	...
	JSPFree.createBillCard("d1","/biapp-cr/freexml/engineTask/cr_engine_tab_task_CODE1.xml", ["保存/onSave/icon-ok"], null);
}
...
function AfterBodyLoad() {
	...
	var taskCmd = JSPFree.doClassMethodCall("com.yusys.cr.engineTask.service.CrEngieTaskBS", "getTaskCmd", {taskType: '表任务'});
...
function onSave() {
	...
	var quarter_report = JSPFree.doClassMethodCall("com.yusys.cr.tabconfig.service.CrCrTabBS","getQuarterReport", {});
