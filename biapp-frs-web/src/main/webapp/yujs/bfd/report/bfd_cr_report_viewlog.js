...
function AfterInit(){
	...
	JSPFree.createBillList("d1","/biapp-bfd/freexml/report/bfd_cr_report_log_CODE1.xml"); //创建列表
...
function onRefresh(){
	str_sql = "report_rid='" + str_rid + "'";
	JSPFree.createBillList("d1","/biapp-bfd/freexml/report/bfd_cr_report_log_CODE1.xml");
	JSPFree.queryDataByConditon(d1_BillList,str_sql);
}
