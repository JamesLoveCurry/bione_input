...
function importdata(){
    ...
    $('#importFileForm'). form('submit',{
        url: v_context + "/bfd/export/business/importchkData1",
        ...
        success: function(result){
            ...
            if (result.success == "true"){
            	...
            	JSPFree.confirm("提示",result.msg,function(_isOK){
                    if(_isOK){
                    	$('#importFileForm').form('submit',{
                	        url: v_context + "/bfd/export/business/importData",
                	        onSubmit: function(){
...
function importdataAll() {
	var confirmMsg = "进行全量导入注意事项\n" +
	    ...
	    var formData = new FormData($("#importFileForm")[0]);
	    $('#importFileForm').form('submit',{
	        url: v_context + "/bfd/export/business/importchkDataAll",
	        onSubmit: function(param){
	        	param.tabName = tab_name
	        },
	        success: function(result){
...
function downloadTemplate() {
    var src = v_context + "/bfd/export/business/downloadTemplate?tabName="
