...
function AfterInit() {
	JSPFree.createBillList("d1","/biapp-bfd/freexml/resultsummary/bfd_result_tab_summary_ranking_v.xml", null, {isSwitchQuery:"N",autoquery:"N",list_ispagebar:"Y"});
...
function historyFn(_btn) {
	...
	JSPFree.openDialog(row.tab_name +"(数据表排名)","/yujs/bfd/resultsummary/bfd_check_result_tab_ranking_history.js", 700, 450, jso_OpenPars, function(_rtdata){});
}
...
function orgFn(_btn) {
	...
	JSPFree.openDialog(row.tab_name +"(机构排名)", "/yujs/bfd/resultsummary/bfd_check_result_tab_ranking_org.js", 900, 450, jso_OpenPars, function(_rtdata){});
}