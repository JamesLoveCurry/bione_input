...
function AfterInit() {
	...
	JSPFree.createBillQuery("d1_A_B", "/biapp-bfd/freexml/resultsummary/bfd_result_summary_q.xml");
...
function queryData(jso_OpenPars, _par) {
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.bfd.result.service.BfdResultSummaryBS", "getResultRuleHistoryChart", jso_par); 
