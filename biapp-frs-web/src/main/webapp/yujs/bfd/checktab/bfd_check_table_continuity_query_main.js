...
function AfterInit() {
	...
	var whereSql = " tab_name_en in ('BFD_201_CLDWDK','BFD_201_CLGRDK','BFD_201_CLWTDK') ";
	JSPFree.createBillTree("d1_A","/biapp-bfd/freexml/busiModel/bfd_cr_tab_ref.xml", {refWhereSQL: whereSql});
	...
	JSPFree.bindBillTreeOnSelect(d1_A_BillTree,function(_node){
	  ...
	  if (isLeaf_1) {  // 如果选中了叶子结点
	  		...
	  		var jso_data = JSPFree.doClassMethodCall("com.yusys.bfd.business.service.BfdBusinessBS","checkTabCols",jso_par); 
	  		...
	  		JSPFree.createOrReplaceIFrame("d1_B","/yujs/bfd/checktab/bfd_check_continuity_data_list.js",v_par);
	  	}
	});
}