...
function AfterInit() {
	...
	JSPFree.createBillCard("d1","/biapp-imas/freexml/report/imas_report_choose.xml",["下一步/onNext","取消/onCancel"]);
}
...
function onNext() {
	...
	JSPFree.openDialogAndCloseMe("打包压缩下载报文","/yujs/imas/report/imas_report_task_zip.js",780,300,{data_dt:str_date,org_no:orgStr,report_type:str_report_type,org_class:org_class,org_nm:org_nm});
}
