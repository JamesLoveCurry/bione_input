...
function AfterInit() {
	...
	str_className = "Class:com.yusys.imas.business.service.ImasModelTempletBuilder.getTemplet('" + tab_name + "','" + tab_name_en + "','" + str_LoginUserOrgNo + "')";

	JSPFree.createBillList("d1", str_className, null, {list_btns:"[icon-add]新增/insert1;[icon-edit]编辑/update1;[icon-remove]删除/delete1;[icon-p81]查看/view1;[icon-p69]导出csv/exportCSV(this);[icon-p69]导出excel/exportExcel(this);[icon-p68]导入excel/importExcel(this)",isSwitchQuery:"N",autoquery:"N",list_ischeckstyle: "Y",list_ismultisel: "Y", refWhereSQL: whereSql});
}
/**
 * 加载页面之后处理
 * @returns
