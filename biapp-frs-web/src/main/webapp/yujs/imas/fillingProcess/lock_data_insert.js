...
function AfterInit() {
    ...
    JSPFree.createBillCard("d1","/biapp-imas/freexml/fillingProcess/imas_lock_data_insert.xml",["确定/onConfirm","取消/onCancel"]);
}
...
function onConfirm(){
    ...
    jso_rt = JSPFree.doClassMethodCall("com.yusys.imas.process.service.ImasLockData", "createLockData", {status:status,str_org:orgStr,tab_name:tabStr,data_dt:jso_cardData.data_dt,operator:str_LoginUserCode,operator_name:str_LoginUserName});
