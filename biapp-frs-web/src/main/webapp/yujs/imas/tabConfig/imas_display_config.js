 ...
 */
function AfterInit() {
	JSPFree.createBillCard("d1", "/biapp-imas/freexml/tabConfig/imas_templet_item.xml",["保存/onConfirm/icon-p21","取消/onCancel/icon-undo"]); // 页签先左右分割
	...
	if(displayConfig !=null && displayConfig!=""){
		...
		var jso_data = JSPFree.doClassMethodCall("com.yusys.imas.tabconfig.service.ImasCrTabBS","getDisplayConfig",jso_par);
