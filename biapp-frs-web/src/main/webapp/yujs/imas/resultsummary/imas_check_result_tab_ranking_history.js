...
function AfterInit() {
	...
	JSPFree.createBillQuery("d1_A", "/biapp-imas/freexml/resultsummary/imas_result_summary_q.xml");
...
function queryData(jso_OpenPars, _par) {
	...
	debugger
	var jso_data = JSPFree.doClassMethodCall("com.yusys.imas.result.service.ImasResultSummaryBS", "getResultTabHistoryChart", jso_par);
