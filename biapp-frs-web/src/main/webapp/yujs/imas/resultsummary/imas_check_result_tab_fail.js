...
function AfterInit() {
	...
	var jsoResult = JSPFree.doClassMethodCall("com.yusys.imas.result.service.ImasResultSummaryBS","getErrorCountByTx", parJson);
	if (jsoResult.notSuperUser == 'Y') {
		...
		var str_className = "Class:com.yusys.imas.result.template.ImasTabFailDetailTemplet.getTemplet('"+tabName+"','"+tabNameEn+"','"+dataDt+"','"+orgNo +"','"+orgType +"')";
...
function getTabTemplateSql(str_data_dt) {
	...
	var jso_sql = JSPFree.doClassMethodCall("com.yusys.imas.result.template.ImasTabFailDetailTemplet","getTabTemplateSql", defvalue);
