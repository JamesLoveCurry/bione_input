...
function onSaveSubmit() {
	...
	JSPFree.confirm('提示', '你确定将数据提交至审批岗?', function(_isOK){
		if (_isOK){
			var jsn_result = JSPFree.doClassMethodCall("com.yusys.cams.corp.service.CamsCorpBSDMO", "submitDataApproval", def);
...
function doUpdateBackStatus(_reason){
	...
	var jsn_result = JSPFree.doClassMethodCall("com.yusys.cams.corp.service.CamsCorpBSDMO","backDataApproval",jso_par);
