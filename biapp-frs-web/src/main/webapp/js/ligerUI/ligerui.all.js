...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
	    ...
	    if (p.initValue != null) g.valueField[0].value = p.initValue;
            g.valueField.attr("data-ligerid", g.id);
            //开关
            g.link = $('<div class="l-trigger"><div class="l-trigger-icon icon-down" style="background: none;font-size: 12px;color: #4bbdfb;line-height: 1.8em;"></div></div>');
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            if (!g.inputText.hasClass("l-text-field"))
                g.inputText.addClass("l-text-field");
            g.link = $('<div class="l-trigger"><div class="l-trigger-icon icon-calendar1" style="background: none;font-size: 18px;color: #4bbdfb;margin-left: -2px;"></div></div>');
...
//        editorTopDiff : 0,                      //编辑器top误差
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                    <div class='l-bar-button l-bar-btnfirst icon-previous2' style='color:#0b5fff;font-weight:700;font-size: 15px;' title='首页'></div>");
            gridhtmlarr.push("                    <div class='l-bar-button l-bar-btnprev icon-back' style='color:#0b5fff;font-weight:700;' title='上一页'></div>");
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'><span class='pcontrol'> <input type='text' size='4' value='1' style='width:30px'  /> / <span></span></span></div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
            gridhtmlarr.push("                     <div class='l-bar-button l-bar-btnnext icon-enter' style='color:#0b5fff;font-weight:700; ' title='下一页'></div>");
            gridhtmlarr.push("                    <div class='l-bar-button l-bar-btnlast icon-next2' style='color:#0b5fff;font-weight:700;font-size: 15px;'title='尾页'></div>");
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
            gridhtmlarr.push("                     <div class='l-bar-button l-bar-btnload icon-refresh' style='color:#0b5fff;font-weight:700;' title='刷新'></div>");
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
...
(function ($)
{
    ...
    $.ligerui.controls.Menu.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addItem: function (item, menu)
        {
            ...
            if(item.icon){
            	 var aitem = $("<i class='icon-manage l-grid-icon' style = 'color : #4bbdfb;'></i>");
