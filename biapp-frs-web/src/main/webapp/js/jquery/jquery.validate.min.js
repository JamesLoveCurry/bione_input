(function (c) {
		...
		c.extend(c.validator, {
				...
				methods : {
					...
					date : function (a, b) {
						var tdate;
						if (a.indexOf('-') != -1 && a.length >= 10) {
							tdate = new Date(new Number(a.substr(0, 4)), new Number(a.substr(5, 2)) - 1, new Number(a.substr(8, 2)));
						} else {
							tdate = new Date(a);
						}
						return this.optional(b) || !/Invalid|NaN/.test(tdate)
					},
...
(function (c) {
		!jQuery.event.special.focusin && !jQuery.event.special.focusout && document.addEventListener && c.each({
				...
				function d(e) {
					...
					if(c.event.dispatch)
						return c.event.dispatch.call(this, e)
				}
				c.event.special[b] = {
					setup : function () {
