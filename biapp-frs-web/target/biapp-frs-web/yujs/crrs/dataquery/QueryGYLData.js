...
function AfterInit(){
	JSPFree.createBillList("d1","/biapp-crrs/freexml/crrs/group/crrs_group_group_client_CODE4.xml",null,{querycontion:"type='2'",autocondition:"type='2'",autoquery:"N",isSwitchQuery:"N"});
...
function onView(){
	...
	JSPFree.openDialog2("基础数据","/yujs/crrs/dataquery/viewGyl.js",950,600,{gylData:gylData},function(_rtdata){
