//初始化界面
function AfterInit() {
	JSPFree.createBillCard("d1","/biapp-crrs/freexml/crrs/summary/crrs_index_config_bydate_CODE1.xml",["保存/onSave/icon-p21","取消/onCancel/icon-undo"],null);
}
...
function onSave(){
	...
	JSPFree.setBillCardValues(d1_BillCard,{rid:FreeUtil.getUUIDFromServer(),index_type:'报表记录数'});
