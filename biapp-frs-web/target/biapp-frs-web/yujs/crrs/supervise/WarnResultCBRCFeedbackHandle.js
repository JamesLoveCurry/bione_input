...
function AfterInit(){
	...
	JSPFree.createBillList("d1","/biapp-crrs/freexml/crrs/rule/crrs_result_warn_FeedBack.xml",null,{list_btns:"[icon-p41]处理/onHandle;$VIEW",querycontion:str_sqlCons,list_ischeckstyle:'Y',list_ismultisel:'Y'});  //确定性校验
