...
function AfterInit(){
	JSPFree.createBillList("d1","/crrs/engine/refer_crrs_engine_task_CODE2",["下一步/onNext/icon-p72"]);
}
...
function onNext(){
	...
	JSPFree.openDialog("把【" + str_fromDate + "】的任务复制到哪个目标日期","/yujs/east/tabtaskdialogtime.js", 500, 420, {fromDate:str_fromDate});
}
