...
function AfterInit(){
	...
	JSPFree.createBillCard("d1_1","/biapp-crrs/freexml/crrs/person/crrs_person_personal_CODE1.xml",["保存/onSave/icon-ok"],null);
	document.getElementById("d1_2").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护个人基本信息</div>";
	document.getElementById("d1_3").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护个人基本信息</div>";
	document.getElementById("d1_4").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护个人基本信息</div>";
	document.getElementById("d1_5").innerHTML="<div style=\"width:100%;text-align:center;\">请先维护个人基本信息</div>";
}
...
function onSave(){
	...
	if ("Y" == ischeck) {
		// 单条数据校验
		var backValue = JSPFree.editTableCheckData(d1_1_BillCard, "Add", "个人基本信息", "CRRS_PERSON_PERSONAL","","2");
		if (backValue == "" || "undifind" == backValue) {
			...
			if(flag){
				...
				var person = JSPFree.getBillCardFormValue(d1_1_BillCard);
				JSPFree.openDialogAndCloseMe2("基础信息","/yujs/crrs/collection/editPerson.js",900,560,{person:person},true);
			}
