...
function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/icrbasic/IcrBasicInformation.xml");
	...
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/icrbasic/IcrBasic1.xml");
	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/icrbasic/IcrBasic2.xml");
	JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/icrbasic/IcrBasic3.xml");
	JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/icrbasic/IcrBasic4.xml");
	JSPFree.createBillList("d1_B_5","/biapp-cr/freexml/icrbasic/IcrBasic5.xml");
	JSPFree.createBillList("d1_B_6","/biapp-cr/freexml/icrbasic/IcrBasic6.xml");
	JSPFree.createBillList("d1_B_7","/biapp-cr/freexml/icrbasic/IcrBasic7.xml");
	JSPFree.createBillList("d1_B_8","/biapp-cr/freexml/icrbasic/IcrBasic8.xml");
	JSPFree.createBillList("d1_B_9","/biapp-cr/freexml/icrbasic/IcrBasic9.xml");
	JSPFree.createBillList("d1_B_10","/biapp-cr/freexml/icrbasic/IcrBasic10.xml");
	JSPFree.createBillList("d1_B_11","/biapp-cr/freexml/icrbasic/IcrBasic11.xml");
