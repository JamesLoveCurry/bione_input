...
function AfterInit() {
	...
	JSPFree.createBillList("d1","/biapp-cr/freexml/engineTask/cr_engine_task_tab_create_ref.xml",["下一步/onNext/icon-p72"]);
...
function onNext(){
	...
	JSPFree.openDialog("把【" + str_fromDate + "】的任务复制到哪个目标日期","/yujs/cr/engineTask/cr_engine_task_tab_dialog_time.js", 500, 420, {fromDate:str_fromDate});
}
