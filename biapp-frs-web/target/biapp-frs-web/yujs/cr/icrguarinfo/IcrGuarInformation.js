...
function AfterInit(){
    ...
    JSPFree.createBillList("d1_A","/biapp-cr/freexml/icrguarinfo/IcrGuarInformation.xml");
    JSPFree.createTabb("d1_B",["其他信息","相关还款责任人","抵质押物信息","在保责任信息"]);
    JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/icrguarinfo/IcrGuarInformation2.xml");
    JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/icrguarinfo/IcrGuarInformation3.xml");
    JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/icrguarinfo/IcrGuarInformation4.xml");
    JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/icrguarinfo/IcrGuarInformation5.xml");
