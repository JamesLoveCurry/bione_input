 ...
 */
 function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/why/Basic_information_list.xml");//基础信息
	//JSPFree.billListBindCustQueryEvent(d1_A_BillList, onSingleSummary);
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/why/Guarantee.xml");  //抵押物
	JSPFree.createBillList("d1_B_3","/biapp-cr/freexml/why/Other_debtor.xml");  //其他债务人信息
	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/why/Pledge_information.xml");  //质押物
	JSPFree.createBillList("d1_B_4","/biapp-cr/freexml/why/Essential_information.xml");  //基本信息
