...
function AfterInit(){
	...
	JSPFree.createBillList("d1_A","/biapp-cr/freexml/entcreditxml/EntCreditInformation.xml");
	JSPFree.createTabb("d1_B",["共同受信人信息","额度信息"]);
	JSPFree.createBillList("d1_B_1","/biapp-cr/freexml/entcreditxml/EntCredit1.xml");
	JSPFree.createBillList("d1_B_2","/biapp-cr/freexml/entcreditxml/EntCredit2.xml");
