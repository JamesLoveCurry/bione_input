...
function AfterInit() {
	...
	JSPFree.createBillQuery("d1_A", "/biapp-cr/freexml/resultsummary/cr_result_summary_q.xml");
...
function queryData(jso_OpenPars, _par) {
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.cr.result.service.CrResultSummaryBS", "getResultTabHistoryChart", jso_par);
