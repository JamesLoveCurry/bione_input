function AfterInit(){
	...
	JSPFree.createBillQuery("d1_A","/biapp-east/freexml/east/result/east_cr_summer_RuleTable.xml");
	...
	JSPFree.bindQueryEvent(d1_A_BillQuery,function(_par){
		  //console.log("查询框传入的查询条件[" + _par + "]");
			...
			var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.CheckReportBS","getRuleTableReport",jso_par); 
