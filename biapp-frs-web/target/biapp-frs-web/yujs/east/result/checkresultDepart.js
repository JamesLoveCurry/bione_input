...
function AfterInit(){
	JSPFree.createBillList("d1","/biapp-east/freexml/east/result/v_east_cr_summary3.xml",null,{isSwitchQuery:"N"});
}
...
function historyFn(_btn){
	...
	JSPFree.openDialog(row.tab_name,"/yujs/east/result/checkresultDepartHistory.js", 700, 450, jso_OpenPars,function(_rtdata){});
}