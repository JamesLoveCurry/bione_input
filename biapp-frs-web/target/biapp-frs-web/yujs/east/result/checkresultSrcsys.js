...
function AfterInit(){
	JSPFree.createBillList("d1","/biapp-east/freexml/east/result/v_east_cr_summary5.xml",null,{isSwitchQuery:"N"});
}
...
function historyFn(_btn){
	...
	var jso_OpenPars = {};
	jso_OpenPars.src_sys = row.src_sys;
	jso_OpenPars.data_dt = row.data_dt;
	jso_OpenPars.tab_name = row.tab_name;
	JSPFree.openDialog(row.tab_name,"/yujs/east/result/checkresultSrcHistory.js", 700, 450, jso_OpenPars,function(_rtdata){});
}