...
function query(jso_OpenPars, _par){
	...
	if(_par != null && _par != ""){
		var jso_par = {"SQLWhere": "col_name='"+colName+"' and summary.tab_name='"+tabNm+"' and "+_par};
	}
	else{
		var date=new Date();
		//年
	...
	var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.EastCheckResultAllHisBS","getInterFieldHistoryChart",jso_par); 
