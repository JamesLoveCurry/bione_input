function AfterInit(){
	...
	JSPFree.createBillQuery("d1_A","/biapp-east/freexml/east/result/east_cr_summer_dataDtRule.xml");
	...
	JSPFree.bindQueryEvent(d1_A_BillQuery,function(_par){
		...
		var jso_data = JSPFree.doClassMethodCall("com.yusys.east.checkresult.summary.service.CheckReportBS","getDataDtRuleReport",jso_par); 
