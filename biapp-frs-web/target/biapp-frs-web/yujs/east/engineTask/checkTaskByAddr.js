...
function AfterInit() {
	...
	JSPFree.createBillList("d1_1", "east/engineTask/east_cr_task_tab_addr",null,{isSwitchQuery:"N"}); // 第1个页签
	JSPFree.createBillList("d1_2", "east/engineTask/east_cr_task_rule_addr",null,{isSwitchQuery:"N"}); // 第2个页签
...
function getCondition() {
	...
	var whereSql = '';
	var jsn_result = JSPFree.doClassMethodCall("com.yusys.east.checkrule.detailmaintenance.service.EastCrRuleTaskBS", "getListAddr", {});
...
function start() {
	...
	var result = JSPFree.doClassMethodCall("com.yusys.east.checkrule.detailmaintenance.service.EastCrRuleTaskBS","checkStart", {allTaskIds: jso_rids, type:'2', isRule: 'Y'});
...
function start2() {
	...
	var result = JSPFree.doClassMethodCall("com.yusys.east.checkrule.detailmaintenance.service.EastCrRuleTaskBS","checkStart", {allTaskIds: jso_rids, type:'2'});
	if (result.code == 'error') {
		$.messager.alert({
			title:'系统提示',
			msg:'<div  style="height:270px;overflow-x: hidden; overflow-y: auto;white-space:pre-wrap;">' + result.msg + '</div>',
