...
function AfterInit(){
	JSPFree.createBillList("d1","east/engineTask/east_cr_task_CODE3",["下一步/onNext/icon-p72"]);
}
...
function onNext(){
	...
	JSPFree.openDialog("把【" + str_fromDate + "】的任务复制到哪个目标日期","/yujs/east/engineTask/ruletaskdialogtime.js", 500, 420, {fromDate:str_fromDate});
}
