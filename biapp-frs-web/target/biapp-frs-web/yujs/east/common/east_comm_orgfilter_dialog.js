 ...
 */
function AfterInit() {
	JSPFree.createBillTreeByBtn("d1","/biapp-east/freexml/common/east_rpt_org_info_comm_filter.xml",["确定/onConfirm/icon-ok","取消/onCancel/icon-clear"],{"isCheckbox":"Y","tree_isCheckboxCascade":"N"});
}
