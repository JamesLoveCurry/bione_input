...
function AfterInit() {
	...
	JSPFree.createBillList("d1","/biapp-east/freexml/east/busiModel/east_cr_tab_ref.xml",["确定/onConfirm/icon-ok","取消/onCancel/icon-clear"],{isSwitchQuery:"N", refWhereSQL: whereSql});
}
