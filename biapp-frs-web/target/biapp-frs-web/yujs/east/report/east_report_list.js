...
function AfterInit(){
    ...
    JSPFree.createBillList("d1","/biapp-east/freexml/east/report/east_report_list_CODE.xml",null,{autoquery:"N",isSwitchQuery:"N", refWhereSQL: whereSql});
...
function onDownload(){
	...
	var jso_par = {
			FileName : "25-EastReportList.xlsx", //指定excel模板文件名称
	...
	JSPFree.downloadFile("com.yusys.east.business.report.service.ExportReportListAsExcelDMO", _downloadName, jso_par); //
}
