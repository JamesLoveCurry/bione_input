...
function doRefreshData(){
	//加载数据!
	var jso_statu = JSPFree.doClassMethodCall("com.yusys.east.business.report.service.YJHBSDMO", "checkCreateReportFileStatu", {data_dt:data_dt});
...
function onStart(){
	...
	if(ary_allTaskIds==null){
		jso_rt = JSPFree.doClassMethodCall("com.yusys.east.business.report.service.YJHBSDMO", 
