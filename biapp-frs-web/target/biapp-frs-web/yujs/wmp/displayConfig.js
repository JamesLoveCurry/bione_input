...
function AfterInit() {
	...
	JSPFree.createBillCard("d1", "/biapp-wmp/freexml/wmp/templetItem.xml",["保存/onConfirm/icon-p21","取消/onCancel/icon-undo"]); // 页签先左右分割
	...
	if(displayConfig !=null && displayConfig!=""){
		...
		var jso_data = JSPFree.doClassMethodCall("com.yusys.wmp.business.service.FrsWmpCrColBS","getDisplayConfig",jso_par); 
