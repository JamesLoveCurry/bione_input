...
function AfterInit(){
	...
	if (jsoIsLine.msg == "OK") {
		JSPFree.createBillList("d1","/biapp-bfd/freexml/fillingProcess/bfd_filling_process_child_CODE4.xml",null,{isSwitchQuery:"N",autoquery:"N",orderbys:"data_dt,tab_name_en"});
	} else {
		JSPFree.createBillList("d1","/biapp-bfd/freexml/fillingProcess/bfd_filling_process_child_CODE1.xml",null,{isSwitchQuery:"N",autoquery:"N",orderbys:"data_dt,tab_name_en"});
	}
...
function getQueryCondition(){
	...
	var jso_rt = JSPFree.doClassMethodCall("com.yusys.bfd.process.service.BfdCrProcessBSDMO", "getQueryCondition",{"_loginUserOrgNo" : str_LoginUserOrgNo} );
	if(jso_rt.msg == "ok"){
		condition = jso_rt.condition;
	}
	return condition;
...
function created(){
	...
	JSPFree.openDialog("填报","/yujs/bfd/fillingProcess/bfd_distribute_detail_fillin1.js",1000,600,jso_Pars,function(_rtData){
		if (_rtData != null) {
...
function exportData(_btn){
	...
	var result= JSPFree.doClassMethodCall("com.yusys.bfd.common.template.BfdCommonTemplate","getZTable",{orgNo: row.rpt_org_no, dataDt: row.data_dt, tableNameEn: row.tab_name_en});
...
function importDatas(){
	JSPFree.openDialog("文件上传","/yujs/bfd/fillingProcess/bfd_distribute_fillin_import.js", 500, 240, null,function(_rtdata){
		if (_rtdata == "success") {
