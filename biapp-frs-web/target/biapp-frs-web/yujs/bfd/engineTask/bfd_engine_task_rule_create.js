...
function AfterInit() {
	...
	JSPFree.createBillList("d1","/biapp-bfd/freexml/engineTask/bfd_engine_task_rule_create_ref.xml",["下一步/onNext/icon-p72"]);
...
function onNext(){
	...
	JSPFree.openDialog("把【" + str_fromDate + "】的任务复制到哪个目标日期","/yujs/bfd/engineTask/bfd_engine_task_rule_dialog_time.js", 500, 420, {fromDate:str_fromDate});
}
