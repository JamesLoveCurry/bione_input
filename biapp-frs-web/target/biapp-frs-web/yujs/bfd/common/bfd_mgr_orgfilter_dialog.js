 ...
 */
function AfterInit() {
	JSPFree.createBillTreeByBtn("d1","/biapp-bfd/freexml/common/bfd_rpt_org_info_mgr_filter.xml",["确定/onConfirm/icon-ok","取消/onCancel/icon-clear"],{"isCheckbox":"Y","tree_isCheckboxCascade":"N"});
}
...
function onConfirm() {
	...
	for(var i=0;i<asy_data.length;i++){
		str_text = str_text + asy_data[i]["mgr_org_no"]+"/"+asy_data[i]["org_nm"]+ ";";
	}
