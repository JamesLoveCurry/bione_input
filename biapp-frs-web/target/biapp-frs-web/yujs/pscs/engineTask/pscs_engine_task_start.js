...
function AfterInit() {
	...
	JSPFree.createBillList("d1_1","/biapp-pscs/freexml/pscs/engineTask/pscs_engine_task_tab_ref.xml");
	// JSPFree.createBillList("d1_2","/biapp-pscs/freexml/pscs/engineTask/pscs_engine_task_rule_ref.xml");
