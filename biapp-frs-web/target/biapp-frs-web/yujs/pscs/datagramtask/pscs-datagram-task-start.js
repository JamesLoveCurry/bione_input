...
function doRefreshData(){
	//加载数据!
	var jso_statu = JSPFree.doClassMethodCall("com.yusys.pscs.datagramtask.service.PscsDatagramTaskBS", "checkCreateReportFileStatu");
...
function onStart(){
	...
	if(ary_allTaskIds==null){
		jso_rt = JSPFree.doClassMethodCall("com.yusys.pscs.datagramtask.service.PscsDatagramTaskBS", 
...
function onLookAllCreateFileTask(){
	JSPFree.openDialog("查看所有在线任务","/yujs/pscs/datagramtask/pscs-datagram-task-view.js",800,600);
}
