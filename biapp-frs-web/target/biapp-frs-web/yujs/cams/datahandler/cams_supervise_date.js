function AfterInit(){
	JSPFree.createBillCard("d1","/biapp-cams/freexml/cams/cams_supervise_date.xml",["确定/onConfirm","取消/onCancel"]);
...
function onConfirm(){
	...
	var jso_rt = JSPFree.doClassMethodCall("com.yusys.cams.datahandler.service.CamsRuleHandler","startAllTask",{data_dt:jso_cardData.data_dt});
