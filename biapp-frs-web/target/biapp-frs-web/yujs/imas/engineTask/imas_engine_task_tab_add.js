...
function AfterInit() {
	...
	JSPFree.createBillCard("d1","/biapp-imas/freexml/engineTask/imas_engine_tab_task_CODE1.xml", ["保存/onSave/icon-ok"], null);
}
...
function AfterBodyLoad() {
	var taskCmd = JSPFree.doClassMethodCall("com.yusys.imas.engineTask.service.ImasEngieTaskBS", "getTaskCmd", {taskType: '表任务'});
