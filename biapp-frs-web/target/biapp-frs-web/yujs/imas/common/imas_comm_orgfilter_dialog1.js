 ...
 */
function AfterInit() {
	JSPFree.createBillTreeByBtn("d1","/biapp-imas/freexml/common/imas_rpt_org_info_comm_filter1.xml",["确定/onConfirm/icon-ok","取消/onCancel/icon-clear"],{"isCheckbox":"Y","tree_isCheckboxCascade":"N"});
}
