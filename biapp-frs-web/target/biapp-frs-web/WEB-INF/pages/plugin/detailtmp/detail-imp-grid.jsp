...
<script type="text/javascript">
	 ...
	 function templateshow() {
   	...
   	function initButton(){
   		...
   		btns.push( {
			text : '取消',
			onclick : function(){
				parent.BIONE.closeDialog("importReports", null, true);
			}
		},{
			text : '保存',
			onclick : save
	...
	function save(){
		$.ajax({
			cache : false,
			async : true,
			url : "${ctx}/report/frame/detailtmp/saveImport",
			dataType : 'json',
			type : "post",
			...
			success : function(result){
				BIONE.hideLoading();
				parent.parent.BIONE.tip("导入成功");
				parent.parent.searchHandler();
				parent.parent.initTab();
				parent.BIONE.closeDialog("importReports", null, true);			
			},
			error:function(){
				BIONE.hideLoading();
