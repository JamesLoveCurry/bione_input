		...
		tab = [
				{
					id : 'fileup',
					title : '模板文件上传',
					src : urlPath+'/validLogicRel/impWin?d=' + new Date().getTime(),
					buttons : [ {
						type : 'next',
						click : function() {
				...
				},
				{
					id : 'validate',
					title : '校验结果查询',
					src : urlPath+'/validLogicRel/tipWin?d=' + new Date().getTime(),
					buttons : [ {
						type : 'pre',
						click : function() {
						}
	...
	function saveInfo() {
		if (window.ehcacheId) {
			...
			$.ajax({
				...
				type : "post",
				dataType : "JSON",
				url : urlPath+"/validLogicRel/impSave?ehcacheId="
