...
jQuery.validator.addMethod("greaterThan", function(value, element, params) {
	...
	$(function() {
		...
		grid = $("#maingrid").ligerGrid({
			...
			alternatingRow:true,
			dataAction:'server',
			url:"${ctx}/rpt/frame/access/idx/user/info.json",
			type:"post",
			sortName:'userNo',
			sortOrder:'desc',
			toolbar:{}
	...
	function detail(userId, userName){
		...
		BIONE.commonOpenLargeDialog("\""+userName+"\"访问详情","editDetail","${ctx}/rpt/frame/access/idx/user/detail?userId="+userId);
	}
	
	//导出Execl
	function exportExcel() {
		var src = '';
		src = "${ctx}/rpt/frame/access/idx/user/exportFile?userNo="+$("#userNo").val()
