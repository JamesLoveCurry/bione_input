...
<script type="text/javascript">
	...
	var field = [{
		...
		options : {
			onBeforeOpen:function(){
				...
				parent.BIONE.commonOpenDialog("主题选择","themeTree",400,380,"${ctx}/cabin/analysis/theme/themeTree"	);
					return false;
			}
		},
		validate : {
	...
	function initData(){
		...
		$.ligerui.get("themeId").setValue(themeId);
		$.ligerui.get("themeId").setText(themeNm);
...
<body>
	<div id="template.center">
		<form name="mainform" method="post" id="mainform"
			action="${ctx}/cabin/analysis/config/saveRela"></form>
	</div>
</body>
</html>