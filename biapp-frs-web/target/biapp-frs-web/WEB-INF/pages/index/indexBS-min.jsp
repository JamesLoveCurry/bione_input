...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/css/classics/ligerUI/Aqua/css/ligerui-all.min.css" />
	<link rel="stylesheet" type="text/css" href="${ctx}/images/classics/icons/icon/style.min.css" />
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="javascript: updatePwd();" class="btn btn-default btn-flat">修改密码</a>
                                </div>
...
<!-- AdminLTE App -->
<script src="${ctx}/static/AdminLTE-With-Iframe/dist/js/app.min.js"></script>
<!--tabs-->
<script src="${ctx}/static/AdminLTE-With-Iframe/dist/js/app_iframe.min.js"></script>
<!--更换头像-->
...
<script type="text/javascript">
	...
	* 本地搜索菜单
    ...
    $(function () {
        ...
        var menuId;
        for(var menu in menus1){
        	if(menus1[menu].text == "首页"){
        		menuId = menus1[menu].id;
        		break;
        	}
        }
