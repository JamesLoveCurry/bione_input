...
<script type="text/javascript">
	...
	function templateshow() {
		...
		var bottomheight = 20;
		$("#all").height($content.height()-10);
		$("#left").height($content.height()-15);
		$("#right").height($content.height()-15);
		var rightHeight = $("#right").height();
		var leftHeight = $("#left").height();
		var $leftTreeContainer = $("#leftTreeContainer");
		$leftTreeContainer.height(leftHeight-32);
		var $leftTreeUl = $("#leftTree");
		$leftTreeUl.height($("#leftTreeContainer").height()-9);

		$("#tab").height($content.height());
		var leftWidth = 300;
		$("#all").width($content.width() );
