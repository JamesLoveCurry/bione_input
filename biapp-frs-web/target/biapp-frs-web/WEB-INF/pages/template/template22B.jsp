...
<script type="text/javascript">
	...
	function templateshow() {
		...
		var bottomheight = 40;
		$("#all").height($content.height() - 75);
		$("#left").height($content.height() - 77);
		$("#right").height($content.height() -77);
		$("#bottom").height(bottomheight);
		var rightHeight = $("#right").height();
		var leftHeight = $("#left").height();
		var $leftTreeContainer = $("#leftTreeContainer");
		$leftTreeContainer.height(leftHeight - 60);
		var $leftTreeUl = $("#leftTree");
		$leftTreeUl.height($("#leftTreeContainer").height() - 40);

		$("#tab").height($("#right").height());
	...
	<div id='all'>
		<div id="left" style="background-color: #FFFFFF">
			...
			<div class="l-form" style="margin: 2px;">
				<ul>
					<li style="width: 80px;">数据源选择：</li>
					<li ><input id="dsImport" style="width: 200px;"/></li>
				</ul>
			</div>
			<div id="treeToolbar"
