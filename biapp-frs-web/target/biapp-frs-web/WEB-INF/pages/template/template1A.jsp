...
<script type="text/javascript">
	...
	function templateshow() {
		$("#center").height($(window).height() - 48);
		if (grid) {
			var centerHeight = $("#center").height();
...
<body>
	<div id="center">
		...
		<div id="bottom" style="height: 40px">
			<div id="saveBtn" class="l-dialog-btn" style="margin-top: 10px;">
				<div class="l-dialog-btn-inner">保存</div>
			</div>
			<div id="cancelBtn" class="l-dialog-btn" style="margin-top: 10px;">
				<div class="l-dialog-btn-inner">取消</div>
			</div>
		</div>
	</div>
</body>
