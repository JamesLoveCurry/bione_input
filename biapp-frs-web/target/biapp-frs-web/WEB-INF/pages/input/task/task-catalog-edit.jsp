...
<script type="text/javascript">
		...
		var groupicon = "${ctx}/images/classics/icons/communication.gif";
			...
			fields : [ {
				...
				validate : {
				    ...
				    maxlength : 100,
	        		remote :  {
	        			url : "${ctx}/rpt/input/task/testSameInputCatalogNm",
						type : "POST",
						data : {
							"upNo" :upNo,
							"catalogId":catalogId
					...
					messages : {
						remote:"相同目录下已存在同名目录"//修改提示内容20190604
					}
				}
			}, {
				display : "备注 ",
	...
	function f_save() {
		...
		BIONE.submitForm($("#mainform"), function() {
			...
			BIONE.closeDialog("rptIdxInputEditCatalog");
		}, function() {
			BIONE.tip("保存失败");
		});
	}
...
<div id="template.center">
	<form name="mainform" method="post" id="mainform" action="${ctx}/rpt/input/task/editIdxInputCatalog.json">
	</form>
</div>
</body>
</html>