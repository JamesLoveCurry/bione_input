function AfterInit(){
  ...
  var str_whereSQL = jso_OpenPars.whereSQL;  //where条件
  var jso_CardData = jso_OpenPars2;  //表单中的实际值

  JSPFree.createBillList("d1",str_templetcode,["确定/onConfirm","取消/onCancel"],{refWhereSQL:str_whereSQL,isSwitchQuery:"N"});  //
}
