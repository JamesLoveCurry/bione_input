...
public class DialectUtils {
	...
	/**
	 * connection, 获取数据库类型并 关闭connection
	 */
	public static String getDataBaseType(Connection conn) {
		return DialectUtils.getDataBaseType(conn, true);
	}
	 ...
	 * @return
	 */
	public static String getDataBaseType(Connection conn, boolean iscloseConnection) {
