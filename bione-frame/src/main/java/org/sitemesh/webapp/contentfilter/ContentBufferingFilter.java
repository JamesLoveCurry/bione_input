...
public abstract class ContentBufferingFilter implements Filter {
	 ...
	 *         be written back out.
	 */
	protected abstract boolean postProcess(String contentType, CharBuffer buffer, HttpServletRequest request,
	 ...
	 */
	protected void writeOriginal(HttpServletResponse response, CharBuffer buffer,
	 ...
	 * modify by songxf at 2012-8-10
	 * description:文件上传时需要 使用MultiPartRequestWrapper
	 */
