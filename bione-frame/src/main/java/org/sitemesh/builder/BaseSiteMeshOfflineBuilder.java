 ...
 */
public abstract class BaseSiteMeshOfflineBuilder extends BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> {
     ...
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setSourceDirectory(Directory sourceDirectory) {
     ...
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setSourceDirectory(File sourceDirectory) {
     ...
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setSourceDirectory(String sourceDirectoryPath) {
     ...
     * mechanisms than a standard file system (e.g. in memory, database, etc).</p>
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setDestinationDirectory(Directory destinationDirectory) {
     ...
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setDestinationDirectory(File destinationDirectory) {
     ...
     * the process is running in.
     */
    public BaseSiteMeshBuilder<OfflineContext, SiteMeshOffline> setDestinationDirectory(String destinationDirectoryPath) {
