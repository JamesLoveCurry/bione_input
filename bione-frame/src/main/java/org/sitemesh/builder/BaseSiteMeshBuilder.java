 ...
 * @author Joe Walnes
 */
public abstract class BaseSiteMeshBuilder<CONTEXT extends SiteMeshContext, RESULT> {
    ...
    protected BaseSiteMeshBuilder<CONTEXT, RESULT> self() {
        return this;
    }
     ...
     * implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addTagRuleBundle(TagRuleBundle bundle) {
     ...
     * implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addTagRuleBundles(TagRuleBundle... bundles) {
     ...
     * implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addTagRuleBundles(Iterable<TagRuleBundle> bundles) {
     ...
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> clearTagRuleBundles() {
     ...
     * implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> setTagRuleBundles(TagRuleBundle... bundles) {
     ...
     * implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> setTagRuleBundles(Iterable<TagRuleBundle> bundles) {
        addTagRuleBundles(bundles);
        return self();
    }
     ...
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> setCustomContentProcessor(ContentProcessor contentProcessor) {
     ...
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addDecoratorPaths(String contentPath, String... decoratorPaths) {
     ...
     * DecoratorSelector implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addDecoratorPaths(String contentPath, List<String> decoratorPaths) {
     ...
     * DecoratorSelector implementation.</p>
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> addDecoratorPath(String contentPath, String decoratorPath) {
     ...
     */
    public BaseSiteMeshBuilder<CONTEXT, RESULT> setCustomDecoratorSelector(DecoratorSelector<CONTEXT> decoratorSelector) {
