 ...
 * @author Joe Walnes
 */
public abstract class BaseSiteMeshFilterBuilder extends BaseSiteMeshBuilder<WebAppContext, Filter> {
     ...
     */
    public BaseSiteMeshBuilder<WebAppContext, Filter> addExcludedPath(String exclude) {
     ...
     */
    public BaseSiteMeshBuilder<WebAppContext, Filter> setMimeTypes(String... mimeTypes) {
     ...
     * <p>Note: The MIME types are ignored if {@link #setCustomSelector(Selector)} is called.</p>
     */
    public BaseSiteMeshBuilder<WebAppContext, Filter> setMimeTypes(List<String> mimeTypes) {
     ...
     */
    public BaseSiteMeshBuilder<WebAppContext, Filter> setCustomSelector(Selector selector) {
